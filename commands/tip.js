...
module.exports = async ({
  ...
  if (!userIsKnown) {
    await reply(
      `@${toUsername} necesita reclamar la propina usando el comando /claim. @${NombreDeUsuario} puede revertir la propina usando el comando "/undo ${unclaimedId}" hasta ese momento`
    );
  }
